...
| **Show Entire Config On-Screen** | `/export` | Prints running configuration directly to terminal session |
...
| Task | Command | Description |
| --- | --- | --- |
| **List All Active IP/MAC Hosts** | `/ip/arp/print` | Displays all discovered network devices via ARP table |
...
| Task | Command | Description |
| --- | --- | --- |
| **Print Filter Rules** | `/ip/firewall/filter/print` | Lists firewall rules with packet and byte counters |
